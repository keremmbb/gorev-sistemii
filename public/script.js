...
function updateCartUI() {
    ...
    if (cart.length === 0) {
        cartItemsElement.innerHTML = '<p style="color: #a0aec0; font-size: 0.85rem; text-align: center;">Sepetiniz şu an boş.</p>';
    }
...
function removeFromCart(rewardName) {
    // Ürünü bul ve miktarını azalt veya tamamen kaldır
